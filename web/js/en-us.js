function LanguageControllerEN()
{
	this.language = {
		...
		titles : {
			...
			"queryPortGroupsResp_PortGroup_dvsType" : "0: vSwitch normal mode, 1:eSwitch-VMDQ express mode 2:SR-IOV express mode(reservation).",
			...
			"queryPortGroupsResp_PortGroup_adminStatus" : "All Port's UP/DOWM status, default value UP;The version of R310 is for to type of Trunk portGroup, optional. 0:UP; 1:DOWN.",
			...
			"queryPortGroupsResp_PortGroup_isEnablePG" : "The switch of portGroup true: on, false:off.",
			"queryPortGroupsResp_PortGroup_vspNum" : "the total of portGroup's vsp。",
			...
			"queryDataStoresReqEx_datastoreQueryParams_statusTd" : "While scope is clusterUrn or storageUnitUrn sign dataStore status, enum value: NORMAL availablel; ABNORMAL not available; CREATING，DELETING",
			...
			"queryDataStoresResp_Datastore_status" : "1.The status of dataStore（NORMAL,ABNORMAL(reservsion),CREATING,DELETING）。",
			"queryDataStoresResp_Datastore_capacityGB" : "The max capacity of dataStore unit:G.",
			"queryDataStoresResp_Datastore_usedSizeGB" : "The userd of dataStore，unit:G.",
			"queryDataStoresResp_Datastore_freeSizeGB" : "The free of dataStore，unit:G.",
			...
			"CreateVmReq_VolumeCreateParams_VmConfig_Disk_sequenceNum" : "Disk sequence Num，every sequence num is 1-23.",
			...
			"CreateVmReq_VolumeCreateParams_VmConfig_Disk_quantityGB" : "Disk quantityGB unit：GB。specification：<br>advanceSan/FusionStorage/local 1G~2048G.",
