...
function queryDataStoresCall()
{
	...
	$.ajax({
		url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/queryDataStoresServlet",
		type : "post",
		dataType : "json",
...
function createVMCall()
{
	...
	httpRequest.open("POST", "/eSDK_FC_1.3_Native_Demo_BS_JAVA/createVMServlet", true); 
...
function queryClusterAndHost()
{
	...
	$.ajax({
		url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/queryClusterAndHostServlet",
		type : "post",
		dataType : "text",
...
function queryOsVersions()
{
	...
	$.ajax({
		url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/queryOsVersionsServlet",
		type : "post",
		dataType : "json",
...
{
	$.ajax({
		url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/getDatastoreUrnServlet",
		type : "post",
		dataType : "json",
...
{
	$.ajax({
		url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/getPortGroupsServlet",
		type : "post",
		dataType : "json",
...
{
	$.ajax({
		url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/getVMFlavorServlet",
		type : "post",
		dataType : "json",
...
{
	$.ajax({
		url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/querySiteUriServlet",
		type : "post",
		dataType : "json",
...
function queryDVSwitchUri()
{
	...
	{
		$.ajax({
			url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/queryDVSwitchUriServlet",
			type : "post",
			dataType : "json",
	...
	if ("queryPortGroups" == functionName)
	{
		$(function() {
			$.ajax({
				type : "get",
				cache : false,
				url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/pages/interface/queryPortGroups.html",
				async : false,
				success : function(data) {
					$("#main1").html(data);
				}
	...
	if ("queryDataStores" == functionName)
	{
		$(function() {
			$.ajax({
				type : "get",
				cache : false,
				url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/pages/interface/queryDataStores.html",
				async : false,
				success : function(data) {
					$("#main1").html(data);
				}
	...
	if ("createVM" == functionName)
	{
		$(function() {
			$.ajax({
				type : "get",
				cache : false,
				url : "/eSDK_FC_1.3_Native_Demo_BS_JAVA/pages/interface/createVM.html",
				async : false,
				success : function(data) {
					$("#main1").html(data);
				}
...
function intialCreateVMReq()
{
	...
	nic.sequenceNum = parseInt($("#sequenceNum").val());
